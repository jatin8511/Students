...
let products = [...AllProducts.earbud, ...AllProducts.tshirt, ...AllProducts.shoes, ...AllProducts.tshirtWomen]
...
const Default = () => {
    productWrapper.innerHTML = randomProducts.map(renderProducts).join('')
}
...
const filterProduct = (category) => {
    if (category == 'all') {
        ...
        productWrapper.innerHTML = AllProducts.earbud.map(renderProductsByCategory).join('')
    }
    else if (category == 'shoes') {
        productWrapper.innerHTML = AllProducts.shoes.map(renderProductsByCategory).join('')
    }
    else if (category == 'tshirt') {
        productWrapper.innerHTML = AllProducts.tshirt.map(renderProductsByCategory).join('')
    }
    else if (category == 'tshirtwomen') {
        productWrapper.innerHTML = AllProducts.tshirtWomen.map(renderProductsByCategory).join('')
    }
}
...
const renderProductsByCategory = (x) => {
    return `<div class="product">
    <div class="img">
        <img src="${x.img}" alt="">
    </div>
...
const Search = () => {
    let searched = products.filter((x) => x.title.toLowerCase().includes(searchInput.value.toLowerCase()))

    productWrapper.innerHTML = searched.map((x) => {
        return `<div class="product">
        <div class="img">
            <img src="${x.img}" alt="">
        </div>
