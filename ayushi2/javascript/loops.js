title.innerHTML = 'javascript loops'

let names = ['jatin', 'maahi', 'deven', 'ayushi', 'hiral']


// for (let i = 0; i < names.length; i++) {
//     res.innerHTML += `<h1> ${names[i]}</h1>`
// }
...
res.innerHTML = earbuds.map((x) => {
    return `
    <div class="product">
        <div class="img"><img src="${x.img}" alt=""></div>
        <h2>${x.title}</h2>
        <h3>₹${x.price}</h3>
